// Test script for text-transcript-parser (ES Module)
import { parseTextTranscript, calculateConfidence, validateTranscript } from './src/lib/text-transcript-parser.ts';
